...
const WORDS = ["Shopify Expert", "Full-Stack Web Developer", "Creative Coder", "UX Advocate", "Problem Solver"];
const TECH_STACK = ["Shopify", "liquid", "Node JS", "Next JS"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/kakao74" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/zlatko-agovic-1971ba36b/" },
  { icon: WhatsApp, link: "+381629233387" },
  { icon: Telegram, link: "https://web.telegram.org/k/#@darkhorse0419" }
];
